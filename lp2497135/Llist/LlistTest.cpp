...
//GOAL: insert items from the back
...
int main(int argv,char *argc[]){
	...
	int n=4;
	Object info1(n),info2(n+1),info3(n+2),info4(n+3);
	...
	cout<<"The size of the fourth object in the List is = " <<x.fromFront(4)->getSize()<<endl;
